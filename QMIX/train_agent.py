...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		env_name = "5m_vs_6m"
		experiment_type = "episodic_team" # episodic_team, episodic_agent, temporal_team, temporal_agent, AREL, ATRR_temporal, ATRR_agent, SeqModel, RUDDER, AREL_agent
		experiment_name = "IDQN_episodic_team"
		dictionary = {
				# TRAINING
				"iteration": i,
				"device": "gpu",
