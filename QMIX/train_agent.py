...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		env_name = "5m_vs_6m"
		experiment_type = "ATRR_temporal" # episodic_team, episodic_agent, temporal_team, temporal_agent, uniform_team_redistribution, AREL, ATRR_temporal, ATRR_agent, SeqModel, RUDDER, AREL_agent
		experiment_name = "IDQN_ATRR_temporal"
		dictionary = {
				# TRAINING
				"iteration": i,
				"device": "gpu",
