		...
		for episode in range(1, self.max_episodes+1):
			...
			for step in range(1, self.max_time_steps+1):
				...
				if self.learn:
					...
					self.buffer.push(states, actions, last_one_hot_action, next_states, next_last_one_hot_action, next_mask_actions, rewards_to_send, dones, indiv_dones)

				states, mask_actions, last_one_hot_action, indiv_dones = next_states, next_mask_actions, next_last_one_hot_action, next_indiv_dones
...
if __name__ == '__main__':
	...
	for i in range(1,6):
		...
		env_name = "5m_vs_6m"
		experiment_type = "AREL" # episodic_team, episodic_agent, temporal_team, temporal_agent, AREL, ATRR, SeqModel, RUDDER
		...
		dictionary["observation_shape"] = env.n_agents+obs[0].shape[0]
