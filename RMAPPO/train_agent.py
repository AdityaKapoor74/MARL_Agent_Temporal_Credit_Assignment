...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		env_name = "5m_vs_6m"
		experiment_type = "ATRR_agent_temporal_attn_weights" # episodic_team, episodic_agent, temporal_team, temporal_agent, uniform_team_redistribution, AREL, ATRR_temporal, ATRR_agent, ATRR_agent_attn_weights, SeqModel, RUDDER, AREL_agent
		...
		dictionary = {
				...
				"version": "agent_temporal_attn_weights", # temporal, agent_temporal, temporal_attn_weights, agent_temporal_attn_weights
		...
		dictionary["reward_model_obs_shape"] = env.n_agents+info["ally_states"].shape[1]+env.n_enemies*(info["enemy_states"].shape[1]+env.n_enemies)
