...
if __name__ == '__main__':
	...
	for i in range(1, 2):
		...
		experiment_name = "MAPPO_reward_prediction_w_final_state_embedding_w_MC_IS" # default setting: reward prediction loss + dynamic loss
		...
		dictionary = {
				...
				"expected_logprob_prediction_loss_coeffecient": 0.0,
