...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		experiment_type = "STAS_agent_temporal_attn_weights" # episodic_team, episodic_agent, temporal_team, temporal_agent, uniform_team_redistribution, ATRR_temporal ~ AREL, ATRR_temporal_v2, ATRR_temporal_attn_weights, ATRR_agent, ATRR_agent_temporal_attn_weights, STAS_agent_temporal
		experiment_name = "MAPPO_STAS_agent_temporal_attn_weights"
