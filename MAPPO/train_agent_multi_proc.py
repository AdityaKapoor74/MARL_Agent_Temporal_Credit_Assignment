...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		experiment_name = "MAPPO_TAR^2_v2_normal_inverse_dynamics_model_w_curr_future_state_past_intermediat_emb_w_final_state_emb_reward_pred" # default setting: reward prediction loss + dynamic loss
