...
if __name__ == '__main__':
	...
	for i in range(1, 6):
		...
		experiment_type = "episodic_team" # episodic_team, episodic_agent, temporal_team, temporal_agent, uniform_team_redistribution, AREL, STAS, TAR^2
		experiment_name = "MAPPO_episodic_team" # default setting: reward prediction loss + dynamic loss
		...
		dictionary = {
				...
				"max_time_steps": 100, # 50 (StarCraft environments -- 100 for 3s5z)/ 40 (Alice_and_Bob)/ 100 (GFootball -- entropy: 4e-3 3v1/ 1e-2 pass_&_shoot/ 2e-3 ca_easy)
