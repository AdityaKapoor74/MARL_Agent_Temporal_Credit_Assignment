...
class Time_Agent_Transformer(nn.Module):
	...
	def forward(self, ally_obs, enemy_obs, obs, actions, episodic_reward, agent_masks):
		...
		current_context_goal = torch.cat([state_past_state_action_embeddings, x_goal_states], dim=-1) # b, n_a, t, t, -1
		upper_triangular_mask = torch.triu(torch.ones(b*n_a, t, t)).reshape(b, n_a, t, t, 1)
