...
class PPOAgent:
	...
	def get_q_values(self, local_states, ally_states, enemy_states, actions, rnn_hidden_state_q, indiv_dones):
		with torch.no_grad():
			...
			agent_masks = 1 - torch.FloatTensor(indiv_dones).unsqueeze(0).unsqueeze(0)
